...
for j = 0.4
    ...
    N1.alpha_r = no_noflux*1.2;
    N2.alpha_a = no_noflux*1.2;
    N2.alpha_r = no_noflux*1.2;
    
    N1.beta_a = no_noflux*0.3;
    N1.beta_r = no_noflux*0.3;
    N2.beta_a = no_noflux*0.3;
    N2.beta_r = no_noflux*0.3;
    ...
    for i = 1:m
        ...
        if (mod(i,1000)==0)
            ...
            if i == 500000
                ...
                exportFigure(['TimeEvolution2B',num2str(i*dt*10),num2str(N2.L),'.pdf'], fig);
